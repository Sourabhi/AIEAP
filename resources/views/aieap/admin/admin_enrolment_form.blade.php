   ...
   <div class="row">
     <div class=" col-sm-offset-1 col-sm-10 ">
       <div class="panel panel-default "> 
         <div class="panel-heading">  <h4><strong>Student Enrolment Form  </strong></h4>
         </div>
         <div class="panel-body">
           {!!Form::open(array('url' => 'adminEnrolment', 'id'=> 'MyForm','data-toggle'=>'validator', 'files'=>'true')) !!}
             ...
             <div class="form-group">
              ...
              <div class="form-group">
               {!!Form::label('courses', 'Courses *', ['class'=>'col-sm-4 control-label']);!!} 
                 <div class="col-sm-8">
                   <select class="form-control select2-multi" name="courses[]" id="courses" multiple="multiple" required="required">
